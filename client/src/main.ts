...
import { renderZoomIntegration } from './view/zoomLink/zoomLinkView.ts';
...
const rana:any = users.find(u=>u.fullName === "Rana");
console.log(rana)

const userCoursers = getUserCourses(rana);

document.querySelector<HTMLDivElement>('#app')!.innerHTML = renderUserCourses(userCoursers)+renderZoomIntegration();
